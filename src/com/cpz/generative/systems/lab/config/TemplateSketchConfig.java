...
import com.cpz.generative.systems.lab.main.TemplateSketch;
...
public class TemplateSketchConfig {
    ...
    public static void settings(TemplateSketch sk) {
        ...
        String propertiesPath = "data" + File.separator + "config" + File.separator + "template" + File.separator + "template-sketch.properties";
    ...
    public static Map<String, Control> configurarControles(TemplateSketch sk) {
        ...
        // btnTemplate
        String templateConfigPath = "data" + File.separator + "config" + File.separator + "template" + File.separator + "template-sketch.json";
